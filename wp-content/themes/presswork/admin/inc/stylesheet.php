 ...
 */
 if(pw_theme_option('content_width')) {
	...
	if($pw_first_sidebar>0 && $loc !== false) {
		$pw_site = 990;//$pw_site + $pw_first_sidebar + $pw_margins;
	}
	if($pw_second_sidebar>0 && $loc2 !== false) {
		$pw_site = 990;//$pw_site + $pw_second_sidebar + $pw_margins;
	}
} else {
	$pw_content_width = 700;
	$pw_first_sidebar = 230;
	$pw_content = 900;
	$pw_margins = 30;
	$pw_site = 990;//$pw_content_width + $pw_first_sidebar + $pw_margins;
}
