<?php wp_footer(); ?>
	...
	<div class="siteinfo row">
		...
		<p><?php printf( __( 'Copyright &copy; 2013-%1$s <br />%2$s'), date('Y'), 'Originally designed by Wordpress and Romangie theme. Jerome refactored with Duoshuo, FontAwesome, Bootstrap.'); ?></p>
		</div>
	</div>
</div> <!-- /footer -->
<?php wp_footer(); ?>
