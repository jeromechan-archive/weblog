<?php get_header(); $options = get_option('flat_options'); ?>
   ...
   <div id="archive_headline">
    <h2><?php _e('Search results for ', 'flat'); echo '[ <span id="keyword">' .$s. "</span> ]"; ?> - <?php $my_query =& new WP_Query("s=$s & showposts=-1"); echo $my_query->post_count; _e(' hit', 'flat'); ?></h2>
   ...
   <div class="post_wrap clearfix" id="no_post">
    <div class="post">
     <h3 class="title"><span><?php _e("Sorry, but you are looking for something that isn't here.","flat"); ?></span></h3>
     <div class="post_content">
