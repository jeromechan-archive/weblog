...
add_dashboard_page( $theme_data['Name'] . 'Theme Updates', __('Theme Update<span class="update-plugins count-1"><span class="update-count">1</span></span>', 'flat'), 'administrator' , 'flat-updates', 'update_notifier');
	}
}  
...
?>
	...
	<style>
        ...
        <div class="wrap">
         ...
         <h2><?php echo $theme_data['Name']; ?><?php _e('Theme Update Information', 'flat');  ?></h2>
         <div id="message" class="updated below-h2">
          <p><?php _e('Current theme version is', 'flat'); ?><?php echo $theme_data['Version']; ?><br /><?php _e('Now you can update to', 'flat');  ?><?php echo $xml->latest; ?></p>
         </div>
         <div id="mono_instructions">
          <h3><?php _e('Please take backup of your theme before updating to latest version!', 'flat');  ?></h3>
          <p style="font-size:16px;">【 <a href="http://www.mono-lab.net/wp-content/uploads/flat.zip"><?php _e('Download latest version', 'flat');  ?></a> 】</p>
          <div id="mono_info">
	   <h3><?php _e('Changelog', 'flat');  ?></h3>
...
function get_latest_theme_version($interval) {
	...
	$notifier_file_url = 'http://www.mono-lab.net/notifier/flat.xml';
	$db_cache_field = 'flat-contempo-notifier-cache';
	$db_cache_field_last_updated = 'flat-contempo-notifier-last-updated';
