...
add_dashboard_page( $theme_data['Name'] . 'Theme Updates', 'テーマ更新<span class="update-plugins count-1"><span class="update-count">1</span></span>' , 'administrator' , 'flat-updates', 'update_notifier');
	}
}  
	...
	<style>
        ...
        <div class="wrap">
         ...
         <div id="mono_instructions">
          ...
          <p style="font-size:16px;">【 <a href="http://www.mono-lab.net/wp-content/uploads/flat.zip">最新版のダウンロードはこちらから。</a> 】</p>
          <div id="mono_info">
	   <h3>更新内容</h3>
...
function get_latest_theme_version($interval) {
	...
	$notifier_file_url = 'http://www.mono-lab.net/notifier/flat-jp.xml';
	$db_cache_field = 'flat-jp-contempo-notifier-cache';
	$db_cache_field_last_updated = 'flat-jp-contempo-notifier-last-updated';
